...
class HelpDialog extends JDialog {
    ...
    public HelpDialog(Boolean defaultValueFlag, String item, String description, String helpInformation, String currentValue, String defaultValue, String possibleValue, String minimumValue,
        ...
        closeButton.getAccessibleContext().setAccessibleName("Close button");
        closeButton.getAccessibleContext().setAccessibleDescription("Close button");
        ...
        if (s.indexOf("|") != -1) {
            if (count > 3) {
                s = s.substring(0, s.lastIndexOf("|")) + ", or " + s.substring(s.lastIndexOf("|") + 1, s.length());
            }
            else {
                s = s.substring(0, s.lastIndexOf("|")) + " or " + s.substring(s.lastIndexOf("|") + 1, s.length());
            }
