...
/******************************************************************************/
/*               ClassifyDetectorForNonDiamondDialog.java                     */
/******************************************************************************/
/*                                                                            */
...
class ClassifyDetectorForNonDiamondDialog extends JDialog {

    static final Dimension SCREEN_SIZE = Toolkit.getDefaultToolkit().getScreenSize();

    int NUMOFFIELD = 3;

    int DATNDI_CLASS_NAM01 = 1;

    int DATNDI_CLASS_LL_01 = 2;

    int DATNDI_CLASS_UL_01 = 3;
    ...
    public ClassifyDetectorForNonDiamondDialog(int detectorNumberParameter) {
        ...
        lblName = lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01];
        beg = lblName.indexOf("Class 01") - 1;
        end = lblName.indexOf("Class 01") + 8;
        lblName = lblName.substring(0, beg) + lblName.substring(end);

        label_field[DATNDI_CLASS_NAM01] = new JTextArea();
        label_field[DATNDI_CLASS_NAM01].setBackground(aFrame.getBackground());
        label_field[DATNDI_CLASS_NAM01].setEditable(false);
        label_field[DATNDI_CLASS_NAM01].setFocusable(false);
        label_field[DATNDI_CLASS_NAM01].setWrapStyleWord(true);
        label_field[DATNDI_CLASS_NAM01].setLineWrap(true);
        label_field[DATNDI_CLASS_NAM01].setFont(font1);
        label_field[DATNDI_CLASS_NAM01].setText(lblName);

        lblName = lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01];
        beg = lblName.indexOf("Class 01") - 1;
        end = lblName.indexOf("Class 01") + 8;
        lblName = lblName.substring(0, beg) + lblName.substring(end);

        label_field[DATNDI_CLASS_LL_01] = new JTextArea();
        label_field[DATNDI_CLASS_LL_01].setBackground(aFrame.getBackground());
        label_field[DATNDI_CLASS_LL_01].setEditable(false);
        label_field[DATNDI_CLASS_LL_01].setFocusable(false);
        label_field[DATNDI_CLASS_LL_01].setWrapStyleWord(true);
        label_field[DATNDI_CLASS_LL_01].setLineWrap(true);
        label_field[DATNDI_CLASS_LL_01].setFont(font1);
        label_field[DATNDI_CLASS_LL_01].setText(lblName);

        lblName = lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01];
        beg = lblName.indexOf("Class 01") - 1;
        end = lblName.indexOf("Class 01") + 8;
        lblName = lblName.substring(0, beg) + lblName.substring(end);

        label_field[DATNDI_CLASS_UL_01] = new JTextArea();
        label_field[DATNDI_CLASS_UL_01].setBackground(aFrame.getBackground());
        label_field[DATNDI_CLASS_UL_01].setEditable(false);
        label_field[DATNDI_CLASS_UL_01].setFocusable(false);
        label_field[DATNDI_CLASS_UL_01].setWrapStyleWord(true);
        label_field[DATNDI_CLASS_UL_01].setLineWrap(true);
        label_field[DATNDI_CLASS_UL_01].setFont(font1);
        label_field[DATNDI_CLASS_UL_01].setText(lblName);
        ...
        for (int lsiv_class = 1; lsiv_class <= PARAMS.TEXAS_MODEL_LDC; lsiv_class++) {
            ...
            lsiv_min = lclv_tx_fmt.msia_min[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class];
            lsiv_max = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class];
            lsiv_inc = lclv_tx_fmt.msia_inc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class];
            ...
            if (lsiv_class == PARAMS.TEXAS_MODEL_LDC) {
                lsiv_min = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                lsiv_max = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                lsiv_inc = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
            }
            else {
                lsiv_min = lclv_tx_fmt.msia_min[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                lsiv_max = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                lsiv_inc = lclv_tx_fmt.msia_inc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
            }
        ...
        for (int lsiv_class = 1; lsiv_class <= PARAMS.TEXAS_MODEL_LDC; lsiv_class++) {
            text_name[lsiv_class].setText(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class]);
            cbo_lower[lsiv_class].setSelectedItem(Integer.toString(lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class]));
            cbo_lower[lsiv_class].setSelectedItem(Integer.toString(lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class]));
        }
    ...
    } // end of method ClassifyDetectorForNonDiamondDialog()
    ...
    void setAccessiblility() {
        for (int lsiv_class = 1; lsiv_class <= PARAMS.TEXAS_MODEL_LDC; lsiv_class++) {
            text_name[lsiv_class].getAccessibleContext().setAccessibleName(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class]);
            text_name[lsiv_class].getAccessibleContext().setAccessibleDescription(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class]);

            cbo_lower[lsiv_class].getAccessibleContext().setAccessibleName(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class]);
            cbo_lower[lsiv_class].getAccessibleContext().setAccessibleDescription(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class]);

            cbo_upper[lsiv_class].getAccessibleContext().setAccessibleName(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class]);
            cbo_upper[lsiv_class].getAccessibleContext().setAccessibleDescription(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class]);
    ...
    void setValueAfterDel(int sum, int index) {
        ...
        text_name[sum].setText(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + sum]);
        cbo_lower[sum].setSelectedItem(Integer.toString(lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + sum]));
        cbo_upper[sum].setSelectedItem(Integer.toString(lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + sum]));
    ...
    class HelpListener extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent event) {
            if (event.getKeyCode() == KeyEvent.VK_F1) {
                ...
                for (int lsiv_class = 1; lsiv_class <= PARAMS.TEXAS_MODEL_LDC; lsiv_class++) {
                    if (event.getSource() == text_name[lsiv_class]) {
                        new HelpDialog(lclv_tx_fmt.mboa_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class], lclv_tx_fmt.mstv_name.replace("#",
                                Integer.toString(detectorNumber)), lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class],
                                lclv_tx_fmt.msta_help[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class], text_name[lsiv_class].getText(),
                                lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class],
                                lclv_tx_fmt.msta_val[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class], " ", " ", " ");
                    }
                    else if (event.getSource() == cbo_lower[lsiv_class]) {
                        new HelpDialog(lclv_tx_fmt.mboa_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class], lclv_tx_fmt.mstv_name.replace("#",
                                Integer.toString(detectorNumber)), lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class],
                                lclv_tx_fmt.msta_help[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class], cbo_lower[lsiv_class].getSelectedItem().toString(),
                                Integer.toString(lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class]), " ",
                                Integer.toString(lclv_tx_fmt.msia_min[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class]),
                                Integer.toString(lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class]),
                                Integer.toString(lclv_tx_fmt.msia_inc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class]));
                    }
                        ...
                        if (lsiv_class == PARAMS.TEXAS_MODEL_LDC) {
                            lsiv_def = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                            lsiv_min = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                            lsiv_max = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                        }
                        else {
                            lsiv_def = lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                            lsiv_min = lclv_tx_fmt.msia_min[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                            lsiv_max = lclv_tx_fmt.msia_max[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
                        }

                        new HelpDialog(lclv_tx_fmt.mboa_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class], lclv_tx_fmt.mstv_name.replace("#",
                                Integer.toString(detectorNumber)), lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class],
                                lclv_tx_fmt.msta_help[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class], cbo_upper[lsiv_class].getSelectedItem().toString(),
                                Integer.toString(lsiv_def), " ", Integer.toString(lsiv_min), Integer.toString(lsiv_max),
                                Integer.toString(lclv_tx_fmt.msia_inc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class]));
                    }

                    if (event.getSource() == up[lsiv_class]) {
    ...
    void saveData() {
        ...
        for (int lsiv_class = numOfClasses + 1; lsiv_class <= PARAMS.TEXAS_MODEL_LDC; lsiv_class++) {
            gdvsim.det_classify_name[detectorNumber][lsiv_class] = lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class];
            gdvsim.det_classify_lower[detectorNumber][lsiv_class] = lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_LL_01 - 1 + lsiv_class];
            gdvsim.det_classify_upper[detectorNumber][lsiv_class] = lclv_tx_fmt.msia_def[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_UL_01 - 1 + lsiv_class];
    ...
    boolean isError() {
        ...
        for (int lsiv_class = 1; lsiv_class <= numOfClasses; lsiv_class++) {
            ...
            fld_name = lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_DETECT_DATNDI_CLASS_NAM01 - 1 + lsiv_class];
        ...
        for (int lsiv_class = 1; lsiv_class <= numOfClasses; lsiv_class++) {
            if (Integer.valueOf(cbo_upper[lsiv_class].getSelectedItem().toString()).intValue() <= Integer.valueOf(cbo_lower[lsiv_class].getSelectedItem().toString()).intValue()) {
                JOptionPane.showMessageDialog(null, "The length upper limit should be greater than the length low limit for class " + lsiv_class + ".", "Error Message", JOptionPane.ERROR_MESSAGE);
                return true;
            }
        }
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            for (int lsiv_class = 1; lsiv_class <= PARAMS.TEXAS_MODEL_LDC; lsiv_class++) {
                if (event.getSource() == cbo_upper[lsiv_class]) {
                    ...
                    if (event.getSource() == del[lsiv_class]) {
                        int numOfClassesBeforeClick;
                        numOfClassesBeforeClick = getNumberOfClasses();
...
} // end of class ClassifyDetectorForNonDiamondDialog.java
