...
class FullactDialog extends JDialog {
    ...
    JTextArea label_sequence;

    JLabel[] label_phase = new JLabel[PARAMS.TEXAS_MODEL_NPH + 1];

    JComboBox[][] comboBox_fullact = new JComboBox[PARAMS.TEXAS_MODEL_NPH + 1][NUMOFFIELD + 1];
    ...
    JLabel[] label_phase_col = new JLabel[PARAMS.TEXAS_MODEL_NPH];
    ...
    public FullactDialog() {
        ...
        lclv_tx_fmt = gdvsim.gclv_inter.mclv_tx_mdl_formats.mcla_tx_fmt[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL];
        ...
        lsiv_min_double = lclv_tx_fmt.mdfa_min[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT];
        lsiv_max_double = lclv_tx_fmt.mdfa_max[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT];
        lsiv_inc_double = lclv_tx_fmt.mdfa_inc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT];
        ...
        lsiv_min_double = lclv_tx_fmt.mdfa_min[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT];
        lsiv_max_double = lclv_tx_fmt.mdfa_max[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT];
        lsiv_inc_double = lclv_tx_fmt.mdfa_inc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT];
        ...
        lsiv_min_double = lclv_tx_fmt.mdfa_min[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG];
        lsiv_max_double = lclv_tx_fmt.mdfa_max[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG];
        lsiv_inc_double = lclv_tx_fmt.mdfa_inc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG];
        ...
        lsiv_min_double = lclv_tx_fmt.mdfa_min[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR];
        lsiv_max_double = lclv_tx_fmt.mdfa_max[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR];
        lsiv_inc_double = lclv_tx_fmt.mdfa_inc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR];
        ...
        lsiv_min_double = lclv_tx_fmt.mdfa_min[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT];
        lsiv_max_double = lclv_tx_fmt.mdfa_max[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT];
        lsiv_inc_double = lclv_tx_fmt.mdfa_inc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT];
        ...
        String[] array_skipPhase = lclv_tx_fmt.msta_val[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH].substring(1).split("\\|");
        String[] array_recall = lclv_tx_fmt.msta_val[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL].substring(1).split("\\|");
        String[] array_minor = lclv_tx_fmt.msta_val[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR].substring(1).split("\\|");
        String[] array_dualLeft = lclv_tx_fmt.msta_val[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT].substring(1).split("\\|");
        ...
        setAllComboBox[ACT_INI_INT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT]));
        setAllComboBox[ACT_VEH_INT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT]));
        setAllComboBox[ACT_YEL_CHG].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG]));
        setAllComboBox[ACT_RED_CLR].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR]));
        setAllComboBox[ACT_MAX_EXT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT]));
        setAllComboBox[ACT_SKIP_PH].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH]);
        setAllComboBox[ACT_RECALL].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL]);
        setAllComboBox[ACT_MINOR].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR]);
        setAllComboBox[ACT_DUAL_LT].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT]);
        ...
        label_field[ACT_INI_INT].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT]);
        label_field[ACT_VEH_INT].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT]);
        label_field[ACT_YEL_CHG].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG]);
        label_field[ACT_RED_CLR].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR]);
        label_field[ACT_MAX_EXT].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT]);
        label_field[ACT_SKIP_PH].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH]);
        label_field[ACT_RECALL].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL]);
        label_field[ACT_MINOR].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR]);
        label_field[ACT_DUAL_LT].setText(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT]);

        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
            comboBox_fullact[lsiv_phase][ACT_INI_INT] = new JComboBox(array_initial);
            comboBox_fullact[lsiv_phase][ACT_VEH_INT] = new JComboBox(array_vehicle);
            comboBox_fullact[lsiv_phase][ACT_YEL_CHG] = new JComboBox(array_yellow);
            comboBox_fullact[lsiv_phase][ACT_RED_CLR] = new JComboBox(array_red);
            comboBox_fullact[lsiv_phase][ACT_MAX_EXT] = new JComboBox(array_extension);
            comboBox_fullact[lsiv_phase][ACT_SKIP_PH] = new JComboBox(array_skipPhase);
            comboBox_fullact[lsiv_phase][ACT_RECALL] = new JComboBox(array_recall);
            comboBox_fullact[lsiv_phase][ACT_MINOR] = new JComboBox(array_minor);
            comboBox_fullact[lsiv_phase][ACT_DUAL_LT] = new JComboBox(array_dualLeft);

            comboBox_fullact[lsiv_phase][ACT_INI_INT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT]));
            comboBox_fullact[lsiv_phase][ACT_VEH_INT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT]));
            comboBox_fullact[lsiv_phase][ACT_YEL_CHG].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG]));
            comboBox_fullact[lsiv_phase][ACT_RED_CLR].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR]));
            comboBox_fullact[lsiv_phase][ACT_MAX_EXT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT]));
            comboBox_fullact[lsiv_phase][ACT_SKIP_PH].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH]);
            comboBox_fullact[lsiv_phase][ACT_RECALL].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL]);
            comboBox_fullact[lsiv_phase][ACT_MINOR].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR]);
            comboBox_fullact[lsiv_phase][ACT_DUAL_LT].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT]);
        }

        if (gdvsim.flag_fullact_ok) {
            for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_INI_INT].setSelectedItem(oneDigits
                            .format(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_ini_int));
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_VEH_INT].setSelectedItem(oneDigits
                            .format(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_veh_int));
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_YEL_CHG].setSelectedItem(oneDigits
                            .format(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_yel_chg));
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_RED_CLR].setSelectedItem(oneDigits
                            .format(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_red_clr));
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_MAX_EXT].setSelectedItem(oneDigits
                            .format(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_max_ext));
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_SKIP_PH].setSelectedItem(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_skip_ph);
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_RECALL].setSelectedItem(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_recall);
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_MINOR].setSelectedItem(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_minor);
                }

                if (gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT] != gdvsim.gclv_inter.TX_DATA_IS_INVALID) {
                    comboBox_fullact[lsiv_phase][ACT_DUAL_LT].setSelectedItem(gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_dual_lt);
                }
            }
        }
        ...
        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH - 1; lsiv_phase++) {
            label_phase_col[lsiv_phase] = new JLabel("Phase " + lsiv_phase);
            label_phase_col[lsiv_phase].setVerticalAlignment(JLabel.BOTTOM);
        }

        label_sequence = new JTextArea("Priority Sequence of Phases to enter after Termination");
        label_sequence.setBackground(aFrame.getBackground());
        label_sequence.setEditable(false);
        label_sequence.setFocusable(false);
        label_sequence.setWrapStyleWord(true);
        label_sequence.setLineWrap(true);
        label_sequence.setFont(font1);
        ...
        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
            for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                comboBox_fullact[lsiv_phase][lsiv_field].addKeyListener(openComboMenuListener);
                comboBox_fullact[lsiv_phase][lsiv_field].addKeyListener(helpListener);
            }
        }
        ...
        addComponent(panel_title, iRow++, 0, 14, 1, 0);
        ...
        addComponent(label_sequence, iRow++, 5 + NUMOFFIELD, 7, 1, 0);
        ...
        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH - 1; lsiv_phase++) {
            addComponent(label_phase_col[lsiv_phase], iRow, ic++, 1, 1, 0);
        }
        iRow++;

        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
            ic = 0;
            addComponent(label_phase[lsiv_phase], iRow, ic++, 1, 1, 0);
            addComponent(add[lsiv_phase], iRow, ic++, 1, 1, 0);
            addComponent(del[lsiv_phase], iRow, ic++, 1, 1, 0);
            addComponent(up[lsiv_phase], iRow, ic++, 1, 1, 0);
            addComponent(down[lsiv_phase], iRow, ic++, 1, 1, 0);

            for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                addComponent(comboBox_fullact[lsiv_phase][lsiv_field], iRow, ic++, 1, 1, 0);
            }
        ...
        addComponent(label_total, iRow++, 2, 2, 1, 0);
    ...
    void setAccessiblity() {
        for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
            setAllComboBox[lsiv_field].getAccessibleContext().setAccessibleName(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for set all");
            setAllComboBox[lsiv_field].getAccessibleContext().setAccessibleDescription(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for set all");
            setAllButton[lsiv_field].getAccessibleContext().setAccessibleName(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for set all");
            setAllButton[lsiv_field].getAccessibleContext().setAccessibleDescription(lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for set all");
        }

        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
            for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                comboBox_fullact[lsiv_phase][lsiv_field].getAccessibleContext().setAccessibleName(
                        lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for phase " + lsiv_phase);
                comboBox_fullact[lsiv_phase][lsiv_field].getAccessibleContext().setAccessibleDescription(
                        lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for phase " + lsiv_phase);
            }
    ...
    int getNumberOfPhase() {
        ...
        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
            if (comboBox_fullact[lsiv_phase][ACT_INI_INT].isEnabled()) {
                numOfPh++;
            }
        }
            ...
            if (event.getKeyCode() == KeyEvent.VK_F1) {
                ...
                for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                    if (event.getSource() == setAllButton[lsiv_field]) {
                        new HelpDialog(true, "Set All Button", "The Set All button sets the value of " + lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]
                ...
                for (int lsiv_field = 1; lsiv_field <= 5; lsiv_field++) {
                    if (event.getSource() == setAllComboBox[lsiv_field]) {
                        new HelpDialog(lclv_tx_fmt.mboa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], lclv_tx_fmt.mstv_name.substring(8),
                                lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for all phases",
                                lclv_tx_fmt.msta_help[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], setAllComboBox[lsiv_field].getSelectedItem().toString(),
                                oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]), " ",
                                oneDigits.format(lclv_tx_fmt.mdfa_min[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]),
                                oneDigits.format(lclv_tx_fmt.mdfa_max[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]),
                                oneDigits.format(lclv_tx_fmt.mdfa_inc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]));
                    }
                }
                ...
                for (int lsiv_field = 6; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                    if (event.getSource() == setAllComboBox[lsiv_field]) {
                        new HelpDialog(lclv_tx_fmt.mboa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], lclv_tx_fmt.mstv_name.substring(8),
                                lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for all phases",
                                lclv_tx_fmt.msta_help[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], setAllComboBox[lsiv_field].getSelectedItem().toString(),
                                lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], lclv_tx_fmt.msta_val[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT
                                        - 1 + lsiv_field],
                                " ", " ", " ");
                    }
                }

                for (int lsiv_phase = 1; lsiv_phase <= 5; lsiv_phase++) {
                    for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                        if (event.getSource() == comboBox_fullact[lsiv_phase][lsiv_field]) {
                            new HelpDialog(lclv_tx_fmt.mboa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], lclv_tx_fmt.mstv_name.substring(8),
                                    lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for Phase " + lsiv_phase,
                                    lclv_tx_fmt.msta_help[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field],
                                    comboBox_fullact[lsiv_phase][lsiv_field].getSelectedItem().toString(), oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT
                                            - 1 + lsiv_field]),
                                    " ", oneDigits.format(lclv_tx_fmt.mdfa_min[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]),
                                    oneDigits.format(lclv_tx_fmt.mdfa_max[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]),
                                    oneDigits.format(lclv_tx_fmt.mdfa_inc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field]));
                ...
                for (int lsiv_phase = 6; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
                    for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                        if (event.getSource() == comboBox_fullact[lsiv_phase][lsiv_field]) {
                            new HelpDialog(lclv_tx_fmt.mboa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], lclv_tx_fmt.mstv_name.substring(8),
                                    lclv_tx_fmt.msta_desc[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field] + " for Phase " + lsiv_phase,
                                    lclv_tx_fmt.msta_help[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field],
                                    comboBox_fullact[lsiv_phase][lsiv_field].getSelectedItem().toString(), lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field],
                                    lclv_tx_fmt.msta_val[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT - 1 + lsiv_field], " ", " ", " ");
                        }
                    }
                }
    ...
    void setStatus(int sumOfPhases) {
        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
            if (lsiv_phase <= sumOfPhases) {
                ...
                for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                    comboBox_fullact[lsiv_phase][lsiv_field].setEnabled(true);
                }
            }
            else {
                ...
                for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                    comboBox_fullact[lsiv_phase][lsiv_field].setEnabled(false);
                }
            }
        }
    ...
    void setValueAfterAdd(int sum, int index) {
        for (int lsiv_phase = sum; lsiv_phase >= index; lsiv_phase--) {
            for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                comboBox_fullact[lsiv_phase + 1][lsiv_field].setSelectedItem(comboBox_fullact[lsiv_phase][lsiv_field].getSelectedItem().toString());
            }
        }
        ...
        } // end of if (gdvsim.flag_detConnForNonNema_ok)
    } // end of method setValueAfterAdd

    void setValueAfterDel(int sum, int index) {
        for (int lsiv_phase = index; lsiv_phase < sum; lsiv_phase++) {
            for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                comboBox_fullact[lsiv_phase][lsiv_field].setSelectedItem(comboBox_fullact[lsiv_phase + 1][lsiv_field].getSelectedItem().toString());
            }
        }

        lclv_tx_fmt = gdvsim.gclv_inter.mclv_tx_mdl_formats.mcla_tx_fmt[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL];

        comboBox_fullact[sum][ACT_INI_INT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT]));
        comboBox_fullact[sum][ACT_VEH_INT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT]));
        comboBox_fullact[sum][ACT_YEL_CHG].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG]));
        comboBox_fullact[sum][ACT_RED_CLR].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR]));
        comboBox_fullact[sum][ACT_MAX_EXT].setSelectedItem(oneDigits.format(lclv_tx_fmt.mdfa_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT]));
        comboBox_fullact[sum][ACT_SKIP_PH].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH]);
        comboBox_fullact[sum][ACT_RECALL].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL]);
        comboBox_fullact[sum][ACT_MINOR].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR]);
        comboBox_fullact[sum][ACT_DUAL_LT].setSelectedItem(lclv_tx_fmt.msta_def[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT]);
    ...
    void setValueAfterUp(int index) {
        ...
        for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
            tempStr = comboBox_fullact[index][lsiv_field].getSelectedItem().toString();
            comboBox_fullact[index][lsiv_field].setSelectedItem(comboBox_fullact[index - 1][lsiv_field].getSelectedItem().toString());
            comboBox_fullact[index - 1][lsiv_field].setSelectedItem(tempStr);
        }
        ...
        } // end of method if (gdvsim.flag_detConnForNonNema_ok)
    ...
    void saveData() {
         ...
         */
        for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT] = gdvsim.gclv_inter.TX_DATA_IS_INVALID;
        }
        ...
        for (int lsiv_phase = 1; lsiv_phase <= getNumberOfPhase(); lsiv_phase++) {
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_ini_int = Double.valueOf(
                    comboBox_fullact[lsiv_phase][ACT_INI_INT].getSelectedItem().toString()).doubleValue();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_veh_int = Double.valueOf(
                    comboBox_fullact[lsiv_phase][ACT_VEH_INT].getSelectedItem().toString()).doubleValue();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_yel_chg = Double.valueOf(
                    comboBox_fullact[lsiv_phase][ACT_YEL_CHG].getSelectedItem().toString()).doubleValue();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_red_clr = Double.valueOf(
                    comboBox_fullact[lsiv_phase][ACT_RED_CLR].getSelectedItem().toString()).doubleValue();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mdfv_act_max_ext = Double.valueOf(
                    comboBox_fullact[lsiv_phase][ACT_MAX_EXT].getSelectedItem().toString()).doubleValue();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_skip_ph = comboBox_fullact[lsiv_phase][ACT_SKIP_PH].getSelectedItem().toString();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_recall = comboBox_fullact[lsiv_phase][ACT_RECALL].getSelectedItem().toString();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_minor = comboBox_fullact[lsiv_phase][ACT_MINOR].getSelectedItem().toString();
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mstv_act_dual_lt = comboBox_fullact[lsiv_phase][ACT_DUAL_LT].getSelectedItem().toString();

            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_INI_INT] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_VEH_INT] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_YEL_CHG] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RED_CLR] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MAX_EXT] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_SKIP_PH] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_RECALL] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_MINOR] = gdvsim.gclv_inter.TX_FROM_USER;
            gdvsim.gclv_inter.mclv_TX_Inter_Data.mclv_tx_sim_data.mclv_tx_sig_setup.mcla_ph[lsiv_phase].mclv_aux.msia_stat[gdvsim.gclv_inter.TX_FMT_SIM_FULL_SIGNAL_ACT_DUAL_LT] = gdvsim.gclv_inter.TX_FROM_USER;
        }

        for (int lsiv_phase_row = 1; lsiv_phase_row <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase_row++) {
            if (lsiv_phase_row <= getNumberOfPhase()) {
                for (int lsiv_phase_col = 1; lsiv_phase_col < PARAMS.TEXAS_MODEL_NPH; lsiv_phase_col++) {
                    if (lsiv_phase_col <= getNumberOfPhase()) {
    ...
    class ComponentActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            for (int lsiv_field = 1; lsiv_field <= NUMOFFIELD; lsiv_field++) {
                if (event.getSource() == setAllButton[lsiv_field]) {
                    for (int lsiv_phase = 1; lsiv_phase <= PARAMS.TEXAS_MODEL_NPH; lsiv_phase++) {
                        comboBox_fullact[lsiv_phase][lsiv_field].setSelectedItem(setAllComboBox[lsiv_field].getSelectedItem().toString());
                    }
                    break;
                }
            }
