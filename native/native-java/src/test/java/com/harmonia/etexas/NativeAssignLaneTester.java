 ...
 * @author ttevendale
 */
public class NativeAssignLaneTester {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        laneMan.setLatitude(0);
        laneMan.setLongitude(0);
        laneMan.setElevation(0);
        ...
        LaneNode node1 = new LaneNode(-146, 8432, 0, 100);
        LaneNode node2 = new LaneNode(-200, 9225, 0, 100);
        LaneNode node3 = new LaneNode(-466, 9000, 0, 100);
        LaneNode node4 = new LaneNode(-500, 10000, 0, 100);
        LaneNode node5 = new LaneNode(55, 83, 0, 30);
        LaneNode node6 = new LaneNode(110, 103, 0, 30);
        LaneNode node7 = new LaneNode(130, 95, 0, 30);
        ...
        lane3.addLaneNode(node7);
        ;
        lane3.setType(Lane.INBOUND);
        ...
        SimpleVehicleImpl bottom_right = new SimpleVehicleImpl(3, 0.00001, 0.00001, 2, 2, 2, 2, 2);

        byte[] bytes = mp.buildRawMapData(laneMan);
        byte[] blob3 = bsmProducer.buildBSM(bottom_right, msgCount);
