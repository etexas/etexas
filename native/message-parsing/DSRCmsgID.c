...
static unsigned int asn_MAP_DSRCmsgID_enum2value_1[] = {
	1,	/* basicSafetyMessage(2) */
	2,	/* basicSafetyMessageVerbose(3) */
	3,	/* commonSafetyRequest(4) */
	4,	/* emergencyVehicleAlert(5) */
	5,	/* intersectionCollisionAlert(6) */
	6,	/* mapData(7) */
	7,	/* nmeaCorrections(8) */
	8,	/* probeDataManagement(9) */
	9,	/* probeVehicleData(10) */
	0,	/* reserved(0) */
	10,	/* roadSideAlert(11) */
	11,	/* rtcmCorrections(12) */
	12,	/* signalPhaseAndTimingMessage(13) */
	13,	/* signalRequestMessage(14) */
	14	/* signalStatusMessage(15) */
	/* This list is extensible */
};
