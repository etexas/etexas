...
/**
 * Template for Report Device Configuration.
 * 
 * @author ablatt
 */
public class ReportTemplate extends DeviceTemplate {
     ...
     */
    public ReportTemplate(String devName, List<String> jarAppIds, List<String> remoteAppIds) {
