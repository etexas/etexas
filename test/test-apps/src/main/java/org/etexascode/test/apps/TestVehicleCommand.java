...
public class TestVehicleCommand implements IOBUBaseApp, IAppName {
    ...
    public void performUpdate(OBUDevice device, Object[] messages, Collection<BasicMessage> receive, Double simTime, AppLogger logger) {
        device.addVehicleCommand(new VehicleSpeedCommand(device.getVehicleInfo().getVehicleID(), VehicleSpeedCommand.MAX_DECELERATE_TO_XX, 0.0));
    }

    @Override
    public String getAppName() {
        return "TestVehicleCommand";
    }
