...
/**
 * A validator for execution ID list REST parameter values.
 * 
 * @author emyers
 */
public class ExecutionIdListValidator extends AbstractValidator<List<Long>> {

    /**
     * Creates a new <code>ExecutionIdListValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public ExecutionIdListValidator(List<Long> value) {
    ...
    public void validate(List<Long> value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException("Invalid Execution ID List", "A valid list of execution IDs is required.");
        }

        ExecutionIdValidator validator = new ExecutionIdValidator(null);
