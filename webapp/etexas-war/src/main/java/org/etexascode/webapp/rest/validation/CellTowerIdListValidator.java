...
/**
 * A validator for cell tower ID list REST parameter values.
 * 
 * @author emyers
 */
public class CellTowerIdListValidator extends AbstractValidator<List<Long>> {

    /**
     * Creates a new <code>CellTowerIdListValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public CellTowerIdListValidator(List<Long> value) {
    ...
    public void validate(List<Long> value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException("Invalid Cell Tower ID List", "A valid list of cell tower IDs is required.");
        }

        CellTowerIdValidator validator = new CellTowerIdValidator(null);
