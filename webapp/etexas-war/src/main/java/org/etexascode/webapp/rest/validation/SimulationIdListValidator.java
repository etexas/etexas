...
/**
 * A validator for simulation ID list REST parameter values.
 * 
 * @author emyers
 */
public class SimulationIdListValidator extends AbstractValidator<List<Long>> {

    /**
     * Creates a new <code>SimulationIdListValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public SimulationIdListValidator(List<Long> value) {
    ...
    public void validate(List<Long> value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException("Invalid Simulation ID List", "A valid list of simulation IDs is required.");
        }

        SimulationIdValidator validator = new SimulationIdValidator(null);
