...
/**
 * A validator for device ID list REST parameter values.
 * 
 * @author emyers
 */
public class DeviceIdListValidator extends AbstractValidator<List<Long>> {

    /**
     * Creates a new <code>DeviceIdListValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public DeviceIdListValidator(List<Long> value) {
    ...
    public void validate(List<Long> value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException("Invalid Device ID List", "A valid list of device IDs is required.");
        }

        DeviceIdValidator validator = new DeviceIdValidator(null);
