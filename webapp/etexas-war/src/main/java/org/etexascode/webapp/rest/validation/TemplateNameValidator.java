...
/**
 * A validator for template name REST parameter values.
 * 
 * @author emyers
 */
public class TemplateNameValidator extends AbstractValidator<String> {

    /**
     * Creates a new <code>TemplateNameValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public TemplateNameValidator(String value) {
    ...
    public void validate(String value) throws WebAppException {
        ...
        String title = "Invalid Template Name";
        ...
        try {
            ...
            throw new WebAppException(title, "A valid template name is required.");
        }
        ...
        throw new WebAppException(title, String.format("The value \"%s\" is not a recognized template name.", value));
    }
}
