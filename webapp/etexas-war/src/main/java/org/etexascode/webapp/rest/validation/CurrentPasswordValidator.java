...
/**
 * A validator for current password REST parameter values.
 * 
 * @author emyers
 */
public class CurrentPasswordValidator extends AbstractValidator<String> {
    ...
    /**
     * Creates a new <code>CurrentPasswordValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public CurrentPasswordValidator(String value) {
    ...
    public void validate(String value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException(title, "A valid current password is required.");
        }
    }
}
