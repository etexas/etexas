...
/**
 * A validator for first name REST parameter values.
 * 
 * @author emyers
 */
public class FirstNameValidator extends AbstractValidator<String> {
    ...
    /**
     * Creates a new <code>FirstNameValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public FirstNameValidator(String value) {
    ...
    public void validate(String value) throws WebAppException {
        ...
        String title = "Invalid First Name";
        ...
        try {
            ...
            throw new WebAppException(title, "A valid first name is required.");
        }
        ...
        try {
            ...
            throw new WebAppException(title, String.format("First names may not exceed %d characters in length.", LengthValidator.MAX_LENGTH));
        }
    }
}
