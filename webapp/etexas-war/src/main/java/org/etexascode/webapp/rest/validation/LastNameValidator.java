...
/**
 * A validator for last name REST parameter values.
 * 
 * @author emyers
 */
public class LastNameValidator extends AbstractValidator<String> {
    ...
    /**
     * Creates a new <code>LastNameValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public LastNameValidator(String value) {
    ...
    public void validate(String value) throws WebAppException {
        ...
        String title = "Invalid Last Name";
        ...
        try {
            ...
            throw new WebAppException(title, "A valid last name is required.");
        }
        ...
        try {
            ...
            throw new WebAppException(title, String.format("Last names may not exceed %d characters in length.", LengthValidator.MAX_LENGTH));
        }
    }
}
