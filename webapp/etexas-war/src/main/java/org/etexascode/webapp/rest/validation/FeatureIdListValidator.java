...
/**
 * A validator for topography feature ID list REST parameter values.
 * 
 * @author emyers
 */
public class FeatureIdListValidator extends AbstractValidator<List<Long>> {

    /**
     * Creates a new <code>FeatureIdListValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public FeatureIdListValidator(List<Long> value) {
    ...
    public void validate(List<Long> value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException("Invalid Feature ID List", "A valid list of feature IDs is required.");
        }

        FeatureIdValidator validator = new FeatureIdValidator(null);
