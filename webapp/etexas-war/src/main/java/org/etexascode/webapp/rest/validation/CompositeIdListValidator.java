...
/**
 * A validator for composite ID list REST parameter values.
 * 
 * @author emyers
 */
public class CompositeIdListValidator extends AbstractValidator<List<Long>> {

    /**
     * Creates a new <code>CompositeIdListValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public CompositeIdListValidator(List<Long> value) {
    ...
    public void validate(List<Long> value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException("Invalid Composite ID List", "A valid list of composite IDs is required.");
        }

        CompositeIdValidator validator = new CompositeIdValidator(null);
