...
/**
 * A validator for empty string REST parameter values.
 * 
 * @author emyers
 */
public class EmptyStringValidator extends AbstractValidator<String> {
    ...
    /**
     * Creates a new <code>EmptyStringValidator</code> with the specified default value.
     * 
    ...
    public void validate(String value) throws WebAppException {
        ...
        if (value.isEmpty()) {
            ...
            throw new WebAppException("Invalid String", "A nonempty string is required.");
        }
    }
}
