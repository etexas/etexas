...
/**
 * A validator for MAC address REST parameter values.
 * 
 * @author emyers
 */
public class MacAddressValidator extends AbstractValidator<Long> {

    /**
     * Creates a new <code>MacAddressValidator</code> with the specified default value.
     * 
     * @param value The default value to validate.
     */
    public MacAddressValidator(Long value) {
    ...
    public void validate(Long value) throws WebAppException {
        ...
        try {
            ...
            throw new WebAppException(title, "A valid MAC address is required.");
        }
    }
}
