 ...
 */
/**
 * @class ETexas.view.composite.CreateCompositeFormController
 * @extends ETexas.view.composite.CompositeFormController
 * 
 * The {@link ETexas.view.composite.CreateCompositeForm} controller.
 * 
 * @author emyers
 */
Ext.define('ETexas.view.composite.CreateCompositeFormController', {
    extend : 'ETexas.view.composite.CompositeFormController',
    alias : 'controller.createcompositeform',
        ...
        if (view.isValid()) {
            ...
            view.submit({
                ...
                success : function(form, action) {
                    ...
                    view.fireEvent('compositeadded', composite.id);
                    Ext.destroy(view);
                },
     ...
     * 
     * Handles the event that is generated when the user clicks the Create Composite Help tool.
     * 
     * @protected
    ...
    onHelpToolClicked : function(tool, e, owner, eOpts) {
        ...
        window.open(ETexas.util.UrlProvider.getHelpContentUrl() + '/Simulations/Composites/create_composite.htm');
    }
});
