 ...
 */
/**
 * @class ETexas.view.command.SignalCommandFormController
 * @extends ETexas.view.command.CommandFormController
 * 
 * The {@link ETexas.view.command.SignalCommandForm} controller.
 * 
 * @author emyers
 */
Ext.define('ETexas.view.command.SignalCommandFormController', {
    extend : 'ETexas.view.command.CommandFormController',
    alias : 'controller.signalcommandform',
    ...
    onCreateButtonClicked : function(button, e, eOpts) {
        ...
        if (view.isValid()) {
            ...
            view.mask('Creating Signal Command...');
            view.submit({
                scope : this,
                method : 'POST',
                url : ETexas.util.UrlProvider.getSignalCommandsUrl(selectedComposite, selectedExecution),
     ...
     * 
     * Handles the event that is generated when the user clicks the Create Signal Command Help tool.
     * 
     * @protected
    ...
    onHelpToolClicked : function(tool, e, owner, eOpts) {
        ...
        window.open(ETexas.util.UrlProvider.getHelpContentUrl() + '/Executions/signal_change.htm');
    }
});
