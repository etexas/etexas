 ...
 */
/**
 * @class ETexas.view.message.MessageWindowController
 * @extends ETexas.view.window.BasicWindowController
 * 
 * The {@link ETexas.view.message.MessageWindow} controller.
 * 
 * @author ttevendale
 */
Ext.define('ETexas.view.message.MessageWindowController', {
     ...
     * 
     * Handles the event that is generated when the user clicks the Message Help tool.
     * 
     * @protected
    ...
    onHelpToolClicked : function(tool, e, owner, eOpts) {
        ...
        window.open(ETexas.util.UrlProvider.getHelpContentUrl() + '/Executions/viewing_messages.htm');
    }
});
