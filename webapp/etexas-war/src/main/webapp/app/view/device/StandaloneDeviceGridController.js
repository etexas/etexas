 ...
 */
/**
 * @class ETexas.view.device.StandaloneDeviceGridController
 * @extends Ext.app.ViewController
 * 
 * The {@link ETexas.view.device.StandaloneDeviceGrid} controller.
 * 
 * @author emyers
 */
Ext.define('ETexas.view.device.StandaloneDeviceGridController', {
    extend : 'Ext.app.ViewController',
    alias : 'controller.standalonedevicegrid',
