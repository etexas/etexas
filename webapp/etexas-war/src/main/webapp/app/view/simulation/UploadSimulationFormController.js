 ...
 */
/**
 * @class ETexas.view.simulation.UploadSimulationFormController
 * @extends ETexas.view.simulation.SimulationFormController
 * 
 * The {@link ETexas.view.simulation.UploadSimulationForm} controller.
 * 
 * @author emyers
 */
Ext.define('ETexas.view.simulation.UploadSimulationFormController', {
    extend : 'ETexas.view.simulation.SimulationFormController',
    alias : 'controller.uploadsimulationform',
    ...
    init : function(view) {
        ...
        view.getForm().baseParams = {
            compositeId : selectedComposite.get('id')
        };
     ...
     * 
     * Handles the event that is generated when the user clicks the Upload Simulation Help tool.
     * 
     * @protected
    ...
    onHelpToolClicked : function(tool, e, owner, eOpts) {
        ...
        window.open(ETexas.util.UrlProvider.getHelpContentUrl() + '/Simulations/Simulations/upload_sim.htm');
    },
    ...
    onUploadButtonClicked : function(button, e, eOpts) {
        ...
        if (view.isValid()) {
            ...
            view.mask('Uploading Simulation...');
            view.submit({
                scope : this,
                method : 'POST',
                ...
                success : function(form, action) {
                    ...
                    view.fireEvent('simulationuploaded', selectedComposite.get('id'), simulation.id);
                    Ext.destroy(view);
                },
