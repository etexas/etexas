 ...
 */
/**
 * @class ETexas.view.simulation.SimulationForm
 * @extends ETexas.view.model.ModelForm
 * 
 * An abstract form panel for {@link ETexas.model.SimulationModel} operations.
 * 
 * @abstract
 * @author emyers
 */
Ext.define('ETexas.view.simulation.SimulationForm', {
    ...
    buildItems : function() {
        ...
        return [ {
            ...
            xtype : 'numberfield',
            reference : 'xCoordinateField',
            id : Ext.id(null, 'x-coordinate-field-'),
            name : 'x',
            ...
            xtype : 'numberfield',
            reference : 'yCoordinateField',
            id : Ext.id(null, 'y-coordinate-field-'),
            name : 'y',
