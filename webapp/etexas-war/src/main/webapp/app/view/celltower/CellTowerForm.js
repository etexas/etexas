 ...
 */
/**
 * @class ETexas.view.celltower.CellTowerForm
 * @extends ETexas.view.model.ModelForm
 * 
 * An abstract form panel for {@link ETexas.model.CellTowerModel} operations.
 * 
 * @abstract
 * @author emyers
 */
Ext.define('ETexas.view.celltower.CellTowerForm', {
    ...
    buildItems : function() {
        ...
        return [ {
            xtype : 'textfield',
            reference : 'providerField',
            id : Ext.id(null, 'provider-field-'),
            name : 'provider',
            fieldLabel : 'Provider',
            minWidth : 350
        }, {
