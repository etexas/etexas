 ...
 */
/**
 * @class ETexas.view.execution.EditExecutionFormController
 * @extends ETexas.view.execution.ExecutionFormController
 * 
 * The {@link ETexas.view.execution.EditExecutionForm} controller.
 * 
 * @author emyers
 */
Ext.define('ETexas.view.execution.EditExecutionFormController', {
    extend : 'ETexas.view.execution.ExecutionFormController',
    alias : 'controller.editexecutionform',
     ...
     * 
     * Handles the event that is generated when the user clicks the Edit Execution Help tool.
     * 
     * @protected
    ...
    onHelpToolClicked : function(tool, e, owner, eOpts) {
        ...
        window.open(ETexas.util.UrlProvider.getHelpContentUrl() + '/Executions/edit_exe.htm');
    },
        ...
        if (view.isValid()) {
            ...
            view.submit({
                ...
                success : function(form, action) {
                    ...
                    view.fireEvent('executionupdated', selectedExecution.get('id'));
                    Ext.destroy(view);
                },
    ...
    validateNameField : function(value) {
        ...
        if (selectedExecution.get('name').toUpperCase() === value.toUpperCase()) {
