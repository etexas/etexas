 ...
 */
/**
 * @class ETexas.view.window.BasicWindowController
 * @extends Ext.app.ViewController
 * 
 * The {@link ETexas.view.window.BasicWindow} controller.
 * 
 * @author emyers
 */
Ext.define('ETexas.view.window.BasicWindowController', {
    extend : 'Ext.app.ViewController',
    alias : 'controller.basicwindow',

    /**
     * @method onCloseButtonClicked
     * 
     * Handles the event that is generated when the user clicks the Close button.
     * 
     * @protected
     ...
     */
    onCloseButtonClicked : function(button, e, eOpts) {
