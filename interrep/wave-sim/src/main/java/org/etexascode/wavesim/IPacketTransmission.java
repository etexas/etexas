...
/**
 * Interface governing how long it takes a packet to make it to its destination This is used in the
 * idealized model
 * 
 * @author ablatt
 */
public interface IPacketTransmission {
    ...
    /**
     * Determine how long it takes for the packet to get from source to destination
     * 
