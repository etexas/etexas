 ...
 * @author jconnelly
 */
public class TestIRSEBaseApp implements IRSEBaseApp {

    public RSEDevice devInf = null;
    ...
    public void performUpdate(RSEDevice device, Object[] messages, Collection<BasicMessage> receive, Double simTime, AppLogger logger) {
        ...
        device.addSignalCommand(new SignalCommand(1, 1.0));
        BasicMessage mr = new DSRCMessage("String", DSRCChannel.CH184, -400, -549765200);
