...
/**
 * Interface for an execution driver.
 * 
 * @author ablatt
 */
public interface IDriver {
     ...
     * @return (true/false) None of the intersection representations are considered completed
     * @throws SimDriverException Wrapper for any caught checked exceptions.
     */
