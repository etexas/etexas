...
/**
 * Unit tests for the node xy 32b frame.
 * 
 * @author ttevendale
 */
public class NodeXY32BTest {
    ...
    public void init() {
        ...
        OffsetB16 x = new OffsetB16(-32760);
        OffsetB16 y = new OffsetB16(32760);

        node = new NodeXY32B(x, y);
    ...
    public void testConstructor() {
        ...
        OffsetB16 x = new OffsetB16(15154);
        OffsetB16 y = new OffsetB16(-8774);

        NodeXY32B node = new NodeXY32B(x, y);
    ...
    public void testConstructorNullX() {
        ...
        new NodeXY32B(null, new OffsetB16(28384));
    }
    ...
    public void testConstructorNullY() {
        ...
        thrown.expect(NullPointerException.class);
        new NodeXY32B(new OffsetB16(28384), null);
    }
    ...
    public void testSetX() {
        ...
        OffsetB16 x = new OffsetB16(12121);

        NodeXY32B node = new NodeXY32B();
        node.setX(x);
    ...
    public void testSetY() {
        ...
        OffsetB16 y = new OffsetB16(-32000);
    ...
    public void testDecodeUPER() {
        ...
        NodeXY32B decodedNode = new NodeXY32B();
    ...
    public void testEquals() {
        ...
        // different x
        node2 = new NodeXY32B(x + 1, y);
        assertFalse(node.equals(node2));

        // different y
        node2 = new NodeXY32B(x, y + 1);
        assertFalse(node.equals(node2));

        // same
        node2 = new NodeXY32B(x, y);
