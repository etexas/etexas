...
/**
 * Unit tests for the node xy 26b frame.
 * 
 * @author ttevendale
 */
public class NodeXY26BTest {
    ...
    public void init() {
        ...
        OffsetB13 x = new OffsetB13(-4000);
        OffsetB13 y = new OffsetB13(4000);

        node = new NodeXY26B(x, y);
    ...
    public void testConstructor() {
        ...
        OffsetB13 x = new OffsetB13(2550);
        OffsetB13 y = new OffsetB13(-3187);

        NodeXY26B node = new NodeXY26B(x, y);
    ...
    public void testConstructorNullX() {
        ...
        new NodeXY26B(null, new OffsetB13(2222));
    }
    ...
    public void testConstructorNullY() {
        ...
        thrown.expect(NullPointerException.class);
        new NodeXY26B(new OffsetB13(3544), null);
    }
    ...
    public void testSetX() {
        ...
        OffsetB13 x = new OffsetB13(2100);

        NodeXY26B node = new NodeXY26B();
        node.setX(x);
    ...
    public void testSetY() {
        ...
        OffsetB13 y = new OffsetB13(3447);
    ...
    public void testDecodeUPER() {
        ...
        NodeXY26B decodedNode = new NodeXY26B();
    ...
    public void testEquals() {
        ...
        // different x
        node2 = new NodeXY26B(x + 1, y);
        assertFalse(node.equals(node2));

        // different y
        node2 = new NodeXY26B(x, y + 1);
        assertFalse(node.equals(node2));

        // same
        node2 = new NodeXY26B(x, y);
