...
/**
 * Unit tests for the node xy 24b frame.
 * 
 * @author ttevendale
 */
public class NodeXY24BTest {
    ...
    public void init() {
        ...
        OffsetB12 x = new OffsetB12(-2000);
        OffsetB12 y = new OffsetB12(2000);

        node = new NodeXY24B(x, y);
    ...
    public void testConstructor() {
        ...
        OffsetB12 x = new OffsetB12(1025);
        OffsetB12 y = new OffsetB12(-1025);

        NodeXY24B node = new NodeXY24B(x, y);
    ...
    public void testConstructorNullX() {
        ...
        new NodeXY24B(null, new OffsetB12(1995));
    }
    ...
    public void testConstructorNullY() {
        ...
        thrown.expect(NullPointerException.class);
        new NodeXY24B(new OffsetB12(1992), null);
    }
    ...
    public void testSetX() {
        ...
        OffsetB12 x = new OffsetB12(1987);

        NodeXY24B node = new NodeXY24B();
        node.setX(x);
    ...
    public void testSetY() {
        ...
        OffsetB12 y = new OffsetB12(1584);
    ...
    public void testDecodeUPER() {
        ...
        NodeXY24B decodedNode = new NodeXY24B();
    ...
    public void testEquals() {
        ...
        // different x
        node2 = new NodeXY24B(x + 1, y);
        assertFalse(node.equals(node2));

        // different y
        node2 = new NodeXY24B(x, y + 1);
        assertFalse(node.equals(node2));

        // same
        node2 = new NodeXY24B(x, y);
