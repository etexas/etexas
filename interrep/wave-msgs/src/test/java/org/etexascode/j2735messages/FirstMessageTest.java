 ...
 */
public class FirstMessageTest extends TestCase {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FirstMessageTest.class);

    /**
     * @return the suite of tests being tested
     */
    public static Test suite() {
        return new TestSuite(FirstMessageTest.class);
    }
     ...
     */
    public FirstMessageTest(String testName) {
        super(testName);
    }
     ...
     * 
     * @param signalDataParam SIMPRO variable data
     * @param camStackPosition The row to look up in the signal indication matrix
     * @param laneNumber The column to look up in the signal indication matrix
    ...
    public void testApp() {
        ...
        for (int i = 1; i <= numLanes; i++) {
            ...
            logger.trace("MAPDATA LaneId: " + i + " " + laneID + " baseXY (" + baseX + ", " + baseY + ") endXY (" + endX + ", " + endY + ")");
        ...
        /**
         * Separation between vehicle and signal message generation
         * 
         * @TODO dranker: Probably want to split these into multiple functions
         */
        ...
        for (int i = 1; i <= numLanes; i++) {
            ...
            // state
            int inboundID = mapdata.IBLN[i - 1];
            if (inboundID == 0) {
                continue;
            }
            ...
            if (i == 1) {
                movementState.setCurrState(SignalLightState.LEFT_ARROW_GREEN);
            }
            if (i == 2) {
                movementState.setCurrState(SignalLightState.RIGHT_ARROW_YELLOW);
            }
        ...
        testPoly.addPoint(4984, 5110);
        testPoly.addPoint(5004, 5110);
        testPoly.addPoint(4984, 4990);
        testPoly.addPoint(5004, 4990);

        // DetectorData detectorDataBroadcast = new DetectorData();
        // detectorDataBroadcast.setId(1);
        //
        // detectorDataBroadcast.setArea(testPoly);
        //
        // detectorDataBroadcast.setLengthDetectCap(false);
        //
        // detectorDataBroadcast.setPresence(true);
        //
        // detectorDataBroadcast.setPresenceDetectCap(true);
        //
        // detectorDataBroadcast.setPulse(0);
        //
        // detectorDataBroadcast.setPulseDetectCap(true);
        //
        // detectorDataBroadcast.setSpeedDetectCap(false);
