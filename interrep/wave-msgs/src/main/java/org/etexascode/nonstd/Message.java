...
/**
 * Marker for any message type.
 * 
 * @author bbadillo
 */
@XmlSeeAlso(value = { BasicSafetyMessage.class, BasicSafetyMessageVerbose.class, MapData.class, SPAT.class, SimData.class, CommonSafetyRequest.class, BasicCellMessage.class })
