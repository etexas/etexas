...
/**
 * An interface that allows objects to subscribe to vehicle events such as when a vehicle enters or
 * leaves the simulation.
 * 
 * @author bbadillo
 */
public interface VehicleManagerListener extends Serializable {
