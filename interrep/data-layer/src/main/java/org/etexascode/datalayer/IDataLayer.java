 ...
 * #L%
 */
package org.etexascode.datalayer;
...
/**
 * This interface defines how the data layer is supposed to operate.
 * 
 * @author ablatt
 */
public interface IDataLayer extends IVehicleLocationDataLayer, IInterRepCoordinationDataLayer, IAppsDataLayer, IWaveSimDataLayer, IAppShutdownDataLayer, IWebAppDataLayer, IRestDataLayer {

    /**
     * Shutdown all the data layer connections etc.
     */
