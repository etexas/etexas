...
/**
 * An implementation for testing that just holds logs in memory and provides access to them.
 * 
 * @author janway
 */
public class TestAppLogsPersistenceLayer implements IAppLogsPersistenceLayer {

    private List<LogData> logs;

    TestAppLogsPersistenceLayer() {
