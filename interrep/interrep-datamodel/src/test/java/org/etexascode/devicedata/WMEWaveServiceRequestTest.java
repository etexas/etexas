 ...
 * @author janway
 */
public class WMEWaveServiceRequestTest {

    private static WMEWaveServiceRequest wsr = new WMEWaveServiceRequest();

    @Test
    public void testGetProviderServiceIdentifier() {
        byte[] id = new byte[] { 1 };
        wsr.setProviderServiceIdentifier(id);
        assertTrue(wsr.getProviderServiceIdentifier()[0] == 1);
    ...
    public void testGetAction() {
        wsr.setAction(WMEWaveServiceRequest.ADD);
        assertTrue(wsr.getAction() == WMEWaveServiceRequest.ADD);
    }
}
