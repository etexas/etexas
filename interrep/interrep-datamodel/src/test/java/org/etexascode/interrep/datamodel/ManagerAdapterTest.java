...
import org.etexascode.interrep.datamodel.xmladapters.ManagerAdapter.XmlMap;
...
public class ManagerAdapterTest {
    ...
    Map<Integer, SignalIndication> siMap = new HashMap<Integer, SignalIndication>();

    XmlMap<SignalIndication> asi = null;
