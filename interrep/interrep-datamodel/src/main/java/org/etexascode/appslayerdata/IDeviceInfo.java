...
/**
 * The information shared by the various device types
 * 
 * @author ablatt
 */
public interface IDeviceInfo extends Serializable, IDable {

    /**
     * Getter
     * 
     * @return The mac for this device
     */
     ...
     * Getter
     * 
     * @return The messages for this device
     */
