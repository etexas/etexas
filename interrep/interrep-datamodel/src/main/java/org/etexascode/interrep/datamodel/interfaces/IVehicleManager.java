 ...
 * @author jrutherford
 */
public interface IVehicleManager extends Iterable<IVehicle> {
     ...
     */
    public IVehicle getVehicle(String vehicleId);
     ...
     *         farthest.
     */
    public List<? extends IVehicle> getVehiclesInLane(int laneId);
