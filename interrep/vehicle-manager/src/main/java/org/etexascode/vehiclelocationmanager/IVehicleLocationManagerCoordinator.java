...
/**
 * This Interface defines the parallelization layer's interface.
 * 
 * @author ablatt
 */
public interface IVehicleLocationManagerCoordinator {

    /**
     * Method which executes all the vehicle location managers
     * 
     * @param stepNum The time step to execute those location managers at
