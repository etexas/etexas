...
/**
 * Basic implementation of the function for finding all the vehicles which came from driveways.
 * 
 * @author ablatt
 */
public class SimpleVehiclesFromDriveway implements IVehiclesFromDriveway {
